...
function parseRow(row) {
  return {
    ...
    taxa_negativa:          (() => { const v = cleanNum(findKey(row,'Taxa Negativa')); return v > 0.1 ? v / 100 : v; })(),
    taxa_positiva:          (() => { const v = cleanNum(findKey(row,'Taxa Positiva') ?? findKey(row,'Taxa Positva')); return v > 0.1 ? v / 100 : v; })(),
